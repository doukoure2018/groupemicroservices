package io.multi.notificationserver.exception;

import com.fasterxml.jackson.databind.exc.UnrecognizedPropertyException;
import io.multi.notificationserver.domain.Response;
...
import static io.multi.notificationserver.utils.RequestUtils.handleErrorResponse;
...
public class HandleException extends ResponseEntityExceptionHandler implements ErrorController {
    ...
    public ResponseEntity<Response> badCredentialsException(BadCredentialsException exception) {
        ...
        return new ResponseEntity<>(handleErrorResponse(exception.getMessage() + ": Incorrect email or password", getRootCauseMessage(exception), request, BAD_REQUEST), BAD_REQUEST);
    }
