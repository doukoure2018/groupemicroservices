    ...
    template: `<div class="layout-sidebar" (mouseenter)="onMouseEnter()" (mouseleave)="onMouseLeave()">
        <div class="layout-sidebar-top">
            <a href="/" style="display:flex;align-items:center;gap:10px;text-decoration:none;">
                <!-- Logo SIRA Guinée (full mode sidebar) — illustration bus+bâtiments + texte intégré. -->
                <img class="layout-sidebar-logo" src="/images/logo-sira-navbar.png" alt="SIRA Guinée — Transport & Immobilier" style="height:40px;width:auto;display:block;" />
                <!-- Slim mode (sidebar collapsed) : icon-only fallback SVG. -->
